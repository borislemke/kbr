...
$config = array(
	...
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/kibarer/public',
	...
	|
	*/
	'upload_dir' => '/media/upload/filemanager/source/',
	...
	|
	*/
	'current_path' => '../../../media/upload/filemanager/source/',
	...
	|
	*/
	'thumbs_base_path' => '../../../media/upload/filemanager/thumbs/',
