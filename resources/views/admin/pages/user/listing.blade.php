...
<!-- <m-fab salmon class="modal-open" data-target="#user-add"><i class="material-icons">add</i></m-fab> -->
<a href="{{ route('admin.accounts', ['term' => null, 'action' => 'create']) }}"><m-fab salmon data-target="#user-add"><i class="material-icons">add</i></m-fab></a>
...
<m-template list class="user-wrapper">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '[delete]', function(event) {
            ...
            var url = "{{ route('api.user.destroy', $id = null) }}/" + id;
            var method = 'delete';
                    ...
                    "render": function (data, type, row) {
                        ...
                        + '<m-table-list-more>'
                            ...
                            + '<m-list-menu data-id="'+ data +'">'
                                + '<a href="'+ baseUrl +'/admin/accounts?action=edit&id='+ data +'"><m-list-menu-item edit data-source="property/get" data-function="populatePropertyEdit">EDIT</m-list-menu-item></a>'
