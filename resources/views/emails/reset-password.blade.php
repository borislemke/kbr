                        ...
                        <table cellpadding="0" cellspacing="0" width="600" align="center" style="background:#fff; padding:30px; border:1px solid #e8e8e8; font-family: 'Helvetica Neue', sans-serif;"> 
                            ...
                            <tr>
                                <td align="center" style="padding:50px 0px;">
                                    ...
                                    <img src="http://dev.kesato.com/newsletter/kbr/email/assets/shield.png" width="100px" style=" display: block; padding-bottom:50px;">
                                    
                                    <p style="line-height: 1.5; font-size: 14px; color:#666666; text-align:center;">		
                                        <strong style="font-size:24px;">Forgot Your Password?</strong> <br><br>
                                        <small style="font-size:14px; ">
                                            No need to worry, Andre ! To reset your password, click the button below.
                                        </small> <br><br><br>

                                        <a href="" style=" background: #ee5b2c; padding: 10px 15px; color: #fff; text-decoration: none;border-radius: 4px; font-size:12px; font-weight: 600;">Reset Password</a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
